                ...
                <div class="container-fluid">
                    ...
                    <div class="logo">
                        ...
                        <a href="index.html" class="logo">
                            ...
                            <span class="logo-large"><i class="mdi mdi-radar"></i> Minton</span>
                        </a>
                        <!-- Image Logo -->
                        <!--<a href="index.html" class="logo">-->
                        <!--<img src="minton-hr-dark/assets/images/logo_dark.png" alt="" height="24" class="logo-lg">-->
                        <!--<img src="minton-hr-dark/assets/images/logo_sm.png" alt="" height="24" class="logo-sm">-->
                        <!--</a>-->
                        ...
                        <ul class="list-inline float-right mb-0">
                            ...
                            <li class="list-inline-item dropdown notification-list">
                                <a class="nav-link dropdown-toggle waves-effect nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="minton-hr-dark/assets/images/users/avatar-1.jpg" alt="user" class="rounded-circle">
                                </a>
